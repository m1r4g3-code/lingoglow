  ...
  return (
    <div className="mx-auto max-w-md text-center">
      ...
      <button
        ...
        className="glow-card mx-auto mt-4 flex h-20 w-20 items-center justify-center rounded-full border border-slate-200 bg-white text-3xl dark:border-slate-800 dark:bg-slate-900"
      ...
      {checked === "correct" && <p className="mt-3 font-semibold text-emerald-500">✓ Correct! It was "{card.front}"</p>}
      {checked === "incorrect" && (
        <p className="mt-3 font-semibold text-rose-500">Not quite — it was "{card.front}"</p>
      )}
      ...
      <div className="mt-5">
        {checked === "idle" ? (
          ...
          <button type="button" onClick={handleNext} className="rounded-lg bg-sky-500 px-5 py-2.5 text-sm font-semibold text-white">
            Next word
          </button>
        )}
      </div>
